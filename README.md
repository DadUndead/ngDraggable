...
``data-allow-style-change="false"`` to disable matrix transformation and just handling dragging events.
``ng-drag-no-touch-delay="true"`` to prevent small delay on touch devices.
